...
namespace Silverback.Messaging.Configuration
{
    ...
    public static class BusConfiguratorSubscribeExtensions
    {
        ...
        ///     The <see cref="IBusConfigurator" /> that references the <see cref="BusOptions" /> instance to
        ///     be configured.
        /// </param>
        /// <param name="handler"> The message handler delegate. </param>
        /// <param name="options">
        ///     A <see cref="SubscriptionOptions" /> instance specifying parallelism options.
        /// </param>
        /// <returns>
        ...
        ///     The type to be used to resolve the subscribers instances.
        /// </typeparam>
