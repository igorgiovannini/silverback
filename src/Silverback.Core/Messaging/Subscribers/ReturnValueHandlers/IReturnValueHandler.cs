...
namespace Silverback.Messaging.Subscribers.ReturnValueHandlers
{
    ...
    {
        /// <summary>
        ///     Returns a boolean value indicating whether this handler instance can handle the specified value.
        /// </summary>
        /// <param name="returnValue">The value to be handled.</param>
        /// <returns>A boolean value indicating whether the value can be handled.</returns>
