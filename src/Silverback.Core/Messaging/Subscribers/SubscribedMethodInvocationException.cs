...
namespace Silverback.Messaging.Subscribers
{
    ...
    public class SubscribedMethodInvocationException : SilverbackException
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SubscribedMethodInvocationException" /> class with
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SubscribedMethodInvocationException" /> class with
        ///     the specified message and related to the specified <see cref="MethodInfo"/>.
        /// </summary>
        /// <param name="methodInfo">The <see cref="MethodInfo"/> of the related subscribed method.</param>
        /// <param name="message">The exception message.</param>
